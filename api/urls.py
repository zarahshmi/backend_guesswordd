...
from api.views import RegisterAPIView, CreateGameAPIView, WaitingGamesAPIView, JoinGameAPIView, GuessLetterAPIView, \
    PauseGameAPIView, ResumeGameAPIView, ProfileAPIView, HistoryAPIView, LeaderboardAPIView
...
urlpatterns = [
    ...
    # path('games/<int:game_id>/detail/', GameDetailAPIView.as_view(), name='game_detail'),
